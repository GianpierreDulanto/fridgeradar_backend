...
class RefrigeratorService:
    ...
    def update(self, refrigerator_id: str, name: str | None, type: str | None, sort_order: int | None, current_user: dict) -> dict:
    ...
    def _to_response(self, fridge) -> dict:
        return {
            "id": str(fridge.id),
            ...
            "updated_at": fridge.updated_at.isoformat(),
        }
